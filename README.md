...
### 대시보드를 통해 실험 결과 제공
absusu는 [Django-controlcenter](https://github.com/byashimov/django-controlcenter)를 이용하여 실험 결과를 대시보드로 제공합니다. 각 실험의 집단별 유저 할당 수와 KPI 수치 등을 차트로 보여줍니다. 대시보드는 실험 진행 중에 Ajax를 통해 실시간으로 업데이트됩니다. 
## User Guide
### 필요한 파이썬 버전 및 패키지
- python 3.6 이상
- django 1.11
